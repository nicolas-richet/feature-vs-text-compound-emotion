...
def parse_args():
    ...
    parser.add_argument('--textualize_audio_levels', default=False, action = 'store_true', help='Should the audio feature scores be textualized in the prompt')
    ...
    parser.add_argument('--model', type=str, default='llama3', choices=['llama3', 'llama2', 'bert'], help='Name of the model "llama3", "llama2".')
    ...
    parser.add_argument('--use_other_class', default=False, action = 'store_true', help='Use the "Other" class in C-EXPR-DB training')
    ...
    parser.add_argument('--use_meld_train_subset', default=False, action = 'store_true', help='Use MELD train subset')
    parser.add_argument('--use_single_frame_per_video', default=False, action = 'store_true', help='Use single frame per video for MELD')
    ...
    parser.add_argument('--init_model', default=False, action='store_true', help='Should the model be initialized from a checkpoint')
    parser.add_argument('--init_model_path', type = str, default='', help ='path to the checkpoint from which the training is started')
